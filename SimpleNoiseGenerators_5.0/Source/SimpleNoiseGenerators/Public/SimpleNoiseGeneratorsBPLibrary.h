...
class USimpleNoiseGeneratorsBPLibrary : public UBlueprintFunctionLibrary
{
	...
	//Circle Noise 2D
	UFUNCTION(BlueprintCallable, BlueprintPure, meta = (DisplayName = "CircleNoise2D", Keywords = "Circle Noise, 2D, Generate, Seed, Size, Attenuation, Thickness"), Category = "Circle Noise Generation")
	static float CircleNoise2D(float X, float Y, float Size, int Seed, float Attenuation, float Thickness);
	//Circle Noise 3D
	UFUNCTION(BlueprintCallable, BlueprintPure, meta = (DisplayName = "SphericalNoise3D", Keywords = "Spherical Noise, 3D, Generate, Seed, Attenuation, Size, Thickness"), Category = "Circle Noise Generation")
	static float SphericalNoise3D(float X, float Y, float Z, int Seed, float Size, float Thickness, float Attenuation);
